...
export const { themeConfig, layoutConfig } = defineThemeConfig({
    app: {
        title: '',
        logo: h('img', { src: logo, style: 'line-height:0; color: rgb(var(--v-global-theme-primary)); height: 30px' }),
        logoPurple: h('img', { src: logoPurple, style: 'line-height:0; color: rgb(var(--v-global-theme-primary)); height: 30px' }),
